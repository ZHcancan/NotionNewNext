...
const BLOG = {
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://p9-passport.byteacctimg.com/img/user-avatar/6ac83d54fa859069402deff46306aaa9~90x90.awebp', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
